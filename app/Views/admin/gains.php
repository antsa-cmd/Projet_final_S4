...
<div class="page-head">
    <h1>Gains</h1>
    <p>Situation des gains générés par les frais (retrait & transfert).</p>
</div>

<div class="grid grid-3">
    <div class="stat">
        <div class="ic"><i data-lucide="pie-chart"></i></div>
        <div class="n tnum"><?= number_format($total, 0, ',', ' ') ?> Ar</div>
        <div class="l">Gain total</div>
    </div>
    <div class="stat">
        <div class="ic"><i data-lucide="arrow-up-right"></i></div>
        <div class="n tnum"><?= number_format($retrait, 0, ',', ' ') ?> Ar</div>
        <div class="l">Gain sur retraits</div>
    </div>
    <div class="stat">
        <div class="ic"><i data-lucide="send"></i></div>
        <div class="n tnum"><?= number_format($transfert, 0, ',', ' ') ?> Ar</div>
        <div class="l">Gain sur transferts</div>
    </div>
</div>

<div class="card mt24">
    <h2>Détail par type d'opération</h2>
    <div class="sub">Total des frais collectés</div>
